#
#  Be sure to run `pod spec lint LXPhotosManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/LIXIANGXLee/LXPhotosManagerModule.git", :tag => "#{spec.version}" }
...
#    spec.source_files  = "LXPhotosManager/*.{swift}"
    ...
    spec.subspec 'LXPhotosBrowser' do |phbrowser|
      ...
      phbrowser.dependency  'LXPhotosManager/LXHelpers'
    end
